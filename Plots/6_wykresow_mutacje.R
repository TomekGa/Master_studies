...
legend(-7,par("usr")[4]+legenda.y,title = "MEAN NUMBER OF MUTATIONS",legend = c("Males with the smallest nr of mutations","Random mating","Smallest nr of common mutations"),col = c("black",kolory[1:2]),text.font = 4,pch = 15,cex = 4)
